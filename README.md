...
- **Drohne** — fliegt auf Zimmer, die man antippt, und zeigt eins vollständig.
  ...
  er aus ist. Das Bild antippen zeigt es groß, wischen sieht sich um — **ganz
  herum**, und ein Tipp auf den Blickstock stellt wieder geradeaus. Beim
  Losfliegen schaut sie von selbst wieder nach vorn.
