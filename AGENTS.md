...
- **Der Aufbau ist zwei Häkchen, eine Tafel und ein Knopf** (`rules/lobby.ts`,
  ...
  **Zuschauen in 2D ist eine eigene Rolle** (`FlatRole` `watch`, früher
  ...
  — er ist nur keine Rolle mehr, die jemand im Aufbau wählt: Angeschaltet wird
  Zuschauen im Optionsmenü der Runde („Zuschauen: an/aus"), und zwar immer.
  Wessen Sicht ein Zuschauer *sonst* noch haben kann, steht in der Reiterzeile
  des Telefons: Archiv, Einsatzkontrolle, Drohne und der Fernseher sind eigene
  Ansichten und keine Kamerastellung, also führt die Wahl dorthin.
