...
| Springen                                                                           | `A` rechts                                                                                                                                                                                                                                                    | `Leertaste`                                                                                                                                                                                                                                                                                                                                    | `A` — nur _aus den Augen_                                   | –                                          |
| Benutzen (von oben)                                                                | – (die Hand fasst an, siehe _Anfassen_)                                                                                                                                                                                                                       | `E` oder Enter                                                                                                                                                                                                                                                                                                                                 | `A`                                                         | Knopf `A`                                  |
...
| Zoom (von oben)                                                                    | –                                                                                                                                                                                                                                                             | Mausrad — vier Stufen als Abstand: 12 · 16 · 22 · 30 m                                                                                                                                                                                                                                                                                         | LB heran · RB zurück                                        | – (Zielstock und Knöpfe brauchen den Platz)                     |
