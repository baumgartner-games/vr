...
describe('die gestauchte Figur', () => {
  ...
  it('schlägt so weit aus, wie die Stärke sagt', () => {
    ...
    // gemessenen Ausschlag mal Stärke mal Tempo.
    ...
    // Halbes Tempo, halber Ausschlag — im Schlendern federt niemand wie im
    // Rennen.
  ...
  it('schreibt in das Objekt, das sie bekommt', () => {
    ...
    expect(squishPose(0.4 * Math.PI, 1, 1, out)).toBe(out);
