...
export class StationUi {
  ...
  private write(): void {
    ...
    const page = `${this.tab}/${this.archiveTab}/${this.archiveRoom}/${this.controlTab}/${this.lens.seat}`;
  ...
  private onClick(event: Event): void {
    ...
    const hit = target?.closest<HTMLElement>(
      '[data-sit],[data-power],[data-tab],[data-room],[data-fly],[data-flip],[data-lamp],[data-home],[data-panel],[data-technician],[data-archive-tab],[data-archive-zoom],[data-archive-back],[data-archive-show],[data-dossier-room],[data-game-menu],[data-page-net],[data-page-vr],[data-check],[data-restart],[data-start-setup],[data-watch-seat],[data-watch-follow],[data-watch-insight]',
    );
    if (!hit) return;
