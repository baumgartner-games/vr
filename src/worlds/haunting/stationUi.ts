...
export class StationUi {
  ...
  private get hasView(): boolean {
    ...
    // Das Archiv hat ein Bild, solange keine Akte aufgeschlagen ist: Ein Tipp
    // auf einen Raum nimmt die Karte weg und zeigt nur noch die Akte.
    return (
      station === 'drone' ||
  ...
  private write(): void {
    ...
    const page = `${station ?? 'van'}/${this.archiveTab}/${this.archiveRoom}/${this.controlTab}/${this.lens.seat}/${this.vanOpen ? 'van' : 'seat'}`;
  ...
  private onClick(event: Event): void {
    ...
    const hit = target?.closest<HTMLElement>(
      '[data-sit],[data-room],[data-fly],[data-flip],[data-van],[data-lamp],[data-home],[data-panel],[data-technician],[data-archive-tab],[data-control-tab],[data-archive-zoom],[data-archive-back],[data-archive-show],[data-dossier-room],[data-game-menu],[data-intent],[data-view],[data-restart],[data-start-setup],[data-watch-seat],[data-watch-follow],[data-watch-insight]',
    );
    if (!hit) return;
