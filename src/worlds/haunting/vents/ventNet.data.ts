...
export const STATION_VENTS: VentNetData = {
  flaps: [
    { id: 'vent-cafeteria', roomId: 'r0', x: -3, z: -32, dir: DIR_S },
    { id: 'vent-upper-engine', roomId: 'r1', x: -36, z: -40, dir: DIR_W },
    { id: 'vent-reactor', roomId: 'r2', x: -37, z: -26, dir: DIR_E },
    { id: 'vent-security', roomId: 'r3', x: -22, z: -31, dir: DIR_E },
    { id: 'vent-medbay', roomId: 'r4', x: -20, z: -33, dir: DIR_W },
    { id: 'vent-lower-engine', roomId: 'r5', x: -36, z: -18, dir: DIR_W },
    { id: 'vent-electrical', roomId: 'r6', x: -18, z: -23, dir: DIR_W },
    { id: 'vent-storage', roomId: 'r7', x: 2, z: -10, dir: DIR_E },
    { id: 'vent-weapons', roomId: 'r8', x: 22, z: -43, dir: DIR_E },
    { id: 'vent-o2', roomId: 'r9', x: 11, z: -33, dir: DIR_W },
    { id: 'vent-navigation', roomId: 'r10', x: 33, z: -27, dir: DIR_S },
    { id: 'vent-admin', roomId: 'r11', x: 12, z: -24, dir: DIR_E },
    { id: 'vent-shields', roomId: 'r12', x: 22, z: -16, dir: DIR_E },
    { id: 'vent-communications', roomId: 'r13', x: 4, z: -10, dir: DIR_W },
  ],
  links: [
